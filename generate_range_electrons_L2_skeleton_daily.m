...
lower_energy_edges = [0.24,0.24,0.25,0.25,0.26,0.27,0.28,0.29,0.30,0.32,0.33,0.35,0.37,0.39,0.41,0.43,0.46,0.49,0.52,0.56,0.6,0.64,0.69,0.74,0.79,0.85,0.92,0.99,1.07,1.15,1.24,1.34,1.45,1.57,1.69,1.83,1.98,2.14,2.32,2.51,2.72,2.94,3.19,3.46,3.74,4.06,4.41,4.77,5.21,5.62]';
...
timeminvalue = spdfdatenumtoepoch(datenum('2000/01/01 00:00:00')+(735236932702/1000/3600/24)); %first Epoch value on first day of data, all taken manually
timemaxvalue = spdfdatenumtoepoch(datenum('2000/01/01 00:00:00')+(780822875132/1000/3600/24)); %last Epoch value on last day of data
timeminvaluepoint = spdfdatenumtoepoch(datenum('2000/01/01 00:00:00')+(735184418000/1000/3600/24)); %first Pointing_timestamp value on first day of data
timemaxvaluepoint = spdfdatenumtoepoch(datenum('2000/01/01 00:00:00')+(780875299000/1000/3600/24)); %last Pointing_timestamp value on last day of data
...
for i = start_datenum:end_datenum
    ...
    file_path_1 = ['C:\Users\2001d\OneDrive - UCB-O365\Desktop\LASP Data\Data release\spdf_cdf_files\l2_electron_files\CIRBE_REPTile-2_L2_electron_',file_datestring_1,'v1_0.nc']; %previously created L2 file
    file_path_2 = ['CIRBE_L1_combined_science_',file_datestring_2,'_V0.nc']; %original combined science file
    file_path_4 = ['C:\Users\2001d\OneDrive - UCB-O365\Desktop\LASP Data\Data release\netcdf file\daily_netcdf_v2_1\CIRBE_REPTile-2_L1_',file_datestring_1,'v2_0.nc']; %previously created (and released) L1 file
    fileID_CIRBE_1 = fopen(file_path_2);
    if fileID_CIRBE_1 > 0

        Datafilename = strjoin(["cirbe_reptile-2_l2_rng_elecs_",file_datestring_1,"_v01_01.cdf"],"");
        ...
        cdflib.putAttrgEntry(skeleton,data_type,0,"CDF_CHAR","L2>Level 2 Data Product>Range Electrons")
        ...
        cdflib.putAttrgEntry(skeleton,data_version,0,"CDF_CHAR","v01_01")
        
        file_id = cdflib.createAttr(skeleton,"Logical_file_id","global_scope");
        cdflib.putAttrgEntry(skeleton,file_id,0,"CDF_CHAR","cirbe_reptile-2_l2_rng_elecs_yyyyMMdd_v01_01")
        ...
        cdflib.putAttrgEntry(skeleton,source,0,"CDF_CHAR","cirbe_reptile-2_l2_rng_elecs")
        
        source_desc = cdflib.createAttr(skeleton,"Logical_source_description","global_scope");
        cdflib.putAttrgEntry(skeleton,source_desc,0,"CDF_CHAR","Colorado Inner Radiation Belt Experiment, Relativistic Electron-Proton Telescope integrated little experiment-2, Level 2 Data Product, Range Electrons")
        ...
        rng_fluxes_e = cdflib.createVar(skeleton,"FEDU","CDF_REAL8",1,50,true,true);
        ...
        cdflib.setVarCompression(skeleton,9,"GZIP_COMPRESSION",6)
        ...
        cdflib.putAttrEntry(skeleton,catdesc,9,"CDF_CHAR","FEDU: Directional Differential Electron Flux 0.3-5.83 MeV, in 50 energy bands")
        cdflib.putAttrEntry(skeleton,catdesc,10,"CDF_CHAR","Integration Period Length in ms")
        cdflib.putAttrEntry(skeleton,catdesc,11,"CDF_CHAR","Pointing Mode of the Spacecraft")
        cdflib.putAttrEntry(skeleton,catdesc,12,"CDF_CHAR","Data Quality Flag")
        cdflib.putAttrEntry(skeleton,catdesc,13,"CDF_CHAR","Secondary Epoch in UTC")
        cdflib.putAttrEntry(skeleton,catdesc,14,"CDF_CHAR","Instrument Pointing Angle Relative to the Local Magnetic Field")
        ...
        cdflib.putAttrEntry(skeleton,fieldnam,9,"CDF_CHAR","FEDU")
        cdflib.putAttrEntry(skeleton,fieldnam,10,"CDF_CHAR","Integration Period")
        cdflib.putAttrEntry(skeleton,fieldnam,11,"CDF_CHAR","Pointing Mode")
        cdflib.putAttrEntry(skeleton,fieldnam,12,"CDF_CHAR","Data Quality Flag")
        cdflib.putAttrEntry(skeleton,fieldnam,13,"CDF_CHAR","Epoch")
        cdflib.putAttrEntry(skeleton,fieldnam,14,"CDF_CHAR","Pointing Angle")
        ...
        cdflib.putAttrEntry(skeleton,validmin,10,"CDF_INT2",int16(100))
        cdflib.putAttrEntry(skeleton,validmin,11,"CDF_INT2",int16(0))
        cdflib.putAttrEntry(skeleton,validmin,12,"CDF_INT2",int16(0))
        cdflib.putAttrEntry(skeleton,validmin,13,"CDF_EPOCH",timeminvaluepoint)
        cdflib.putAttrEntry(skeleton,validmin,14,"CDF_REAL4",single(0))
        ...
        cdflib.putAttrEntry(skeleton,validmax,9,"CDF_REAL8",double(1E10))
        cdflib.putAttrEntry(skeleton,validmax,10,"CDF_INT2",int16(5000))
        cdflib.putAttrEntry(skeleton,validmax,11,"CDF_INT2",int16(3))
        cdflib.putAttrEntry(skeleton,validmax,12,"CDF_INT2",int16(2))
        cdflib.putAttrEntry(skeleton,validmax,13,"CDF_EPOCH",timemaxvaluepoint)
        cdflib.putAttrEntry(skeleton,validmax,14,"CDF_REAL4",single(180))
        ...
        cdflib.putAttrEntry(skeleton,scalemax,9,"CDF_REAL8",double(1E8))
        ...
        cdflib.putAttrEntry(skeleton,units,9,"CDF_CHAR","#/cm^2/sr/s/MeV")
        cdflib.putAttrEntry(skeleton,units,10,"CDF_CHAR","ms")
        cdflib.putAttrEntry(skeleton,units,11,"CDF_CHAR"," ")
        cdflib.putAttrEntry(skeleton,units,12,"CDF_CHAR","0=Valid Data")
        cdflib.putAttrEntry(skeleton,units,13,"CDF_CHAR","ms")
        cdflib.putAttrEntry(skeleton,units,14,"CDF_CHAR","degrees")
        ...
        cdflib.putAttrEntry(skeleton,lablaxis,9,"CDF_CHAR","FEDU")
        cdflib.putAttrEntry(skeleton,lablaxis,10,"CDF_CHAR","Integration Period")
        cdflib.putAttrEntry(skeleton,lablaxis,11,"CDF_CHAR","Pointing Mode")
        cdflib.putAttrEntry(skeleton,lablaxis,12,"CDF_CHAR","Data Quality Flag")
        cdflib.putAttrEntry(skeleton,lablaxis,13,"CDF_CHAR","Epoch")
        cdflib.putAttrEntry(skeleton,lablaxis,14,"CDF_CHAR","Pointing Angle")
        ...
        cdflib.putAttrEntry(skeleton,fillval,10,"CDF_INT2",int16(-32768))
        cdflib.putAttrEntry(skeleton,fillval,11,"CDF_INT2",int16(-32768))
        cdflib.putAttrEntry(skeleton,fillval,12,"CDF_INT2",int16(-32768))
        cdflib.putAttrEntry(skeleton,fillval,13,"CDF_EPOCH",time_fillval)
        cdflib.putAttrEntry(skeleton,fillval,14,"CDF_REAL4",single(-1.0E31))
        ...
        cdflib.putAttrEntry(skeleton,format,9,"CDF_CHAR","E11.5")
        cdflib.putAttrEntry(skeleton,format,10,"CDF_CHAR","I4")
        cdflib.putAttrEntry(skeleton,format,11,"CDF_CHAR","I1")
        cdflib.putAttrEntry(skeleton,format,12,"CDF_CHAR","I1")
        cdflib.putAttrEntry(skeleton,format,14,"CDF_CHAR","F8.4")
        ...
        cdflib.putAttrEntry(skeleton,var_type,11,"CDF_CHAR","support_data")
        ...
        cdflib.putAttrEntry(skeleton,depend_0,14,"CDF_CHAR","Epoch_2")
        ...
        cdflib.putAttrEntry(skeleton,time_scale,13,"CDF_CHAR","UTC")
        ...
        cdflib.putAttrEntry(skeleton,monoton,13,"CDF_CHAR","INCREASE")
        
        % GETTING VARIABLE VALUES

        mainepoch = double(ncread(file_path_1,"Epoch"));  %Epoch values from L2 file, these are in UTC, could be taken from L1
        ...
        altitude = single(ncread(file_path_1,"Alt")); %position and magnetic position variables taken from L2, but could be taken from L1
        ...
        rngfluxes = double(ncread(file_path_1,"Eflux_RNG"))';
        rngfluxes(isnan(rngfluxes))=double(-1.0E31);
        ...
        for k = linspace(0,length(mainepoch)-1,length(mainepoch)) 
            ...
            cdflib.putVarRecordData(skeleton,rng_fluxes_e,k,rngfluxes(k+1,:))
...
[cddata_flux,cdinfo_flux] = cdfread("cirbe_reptile-2_l2_rng_elecs_20240110_v01_01.cdf");
